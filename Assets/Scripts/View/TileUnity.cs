...
namespace RogueSharpTutorial.View
{
    public class TileUnity : PooledObject
    {
        ...
        public int SpriteImageOrder
        {
            get { return spriteObject.GetComponent<SpriteRenderer>().sortingOrder; }
            set { spriteObject.GetComponent<SpriteRenderer>().sortingOrder = value; }
        }
